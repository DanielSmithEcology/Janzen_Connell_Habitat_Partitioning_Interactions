#!/usr/bin/env Rscript
# ==========================================================
# Script: SI_Figure_Cov_scatter_avar
#
# Description:
#   Generates SI Figure with Covariance (a_Var variant) — 1×3 panel:
#     • Left: species richness heatmap
#     • Middle: scaled covariance heatmap
#     • Right: scatterplot of richness vs covariance
#
# Input:
#   HP_JCE_Sims/Outputs/Fig_4/simulation_outputs_Fig_4/Fig_4_a_Var/Summary_Fig_4_avar.csv
#   Note: Not actually figure 4 -- but same format as figure 4

# Outputs:
#   Figures/Fig4_1x3_Richness_Covariance_Scatter_avar.svg
#   Figures/Fig4_1x3_Richness_Covariance_Scatter_avar.png
# ==========================================================
...
svg_out <- file.path(figures_dir, "Fig4_1x3_Richness_Covariance_Scatter_avar.svg")
png_out <- file.path(figures_dir, "Fig4_1x3_Richness_Covariance_Scatter_avar.png")
