#!/usr/bin/env Rscript
# ==========================================================
# Script:SI_FIgure_Cov_scatter_Tol_Fec.R
#
# Description:
#   Generates SI Figure with Covariance (Tolerance variant) — 1×3 panel:
#     • Left: species richness heatmap
#     • Middle: scaled covariance heatmap
#     • Right: scatterplot of richness vs covariance
#
# Input:
#   HP_JCE_Sims/Outputs/Fig_4/simulation_outputs_Fig_4/Fig_4_Tolerance/Summary_Fig_4_Tolerance.csv
#   Note: Not actually figure 4 -- but same format as figure 4
#
# Outputs:
#   Figures/Fig4_1x3_Richness_Covariance_Scatter_StressTol.svg
#   Figures/Fig4_1x3_Richness_Covariance_Scatter_StressTol.png
# ==========================================================
...
data_dir    <- file.path(repo_dir, "HP_JCE_Sims", "Outputs", "Fig_4",
                         "simulation_outputs_Fig_4", "Fig_4_Tolerance")
figures_dir <- file.path(repo_dir, "Figures")
if (!dir.exists(figures_dir)) dir.create(figures_dir, recursive = TRUE, showWarnings = FALSE)

# ---- Load data ----
df <- read.csv(file.path(data_dir, "Summary_Fig_4_Tolerance.csv"),
...
svg_out <- file.path(figures_dir, "Fig4_1x3_Richness_Covariance_Scatter_StressTol.svg")
png_out <- file.path(figures_dir, "Fig4_1x3_Richness_Covariance_Scatter_StressTol.png")
