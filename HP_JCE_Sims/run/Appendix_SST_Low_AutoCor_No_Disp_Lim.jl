...
output_dir = joinpath(@__DIR__, "..", "Outputs", "Appendix_SST", "Low_Auto_No_Disp_Lim")
...
for neigh in Moore_Neigh_vals, Z in Z_vals
    push!(tasks, @spawn begin
        ...
        config = SimulationConfig(
            grid_size = 175,
            n_species = 500,
            n_generations = 35000,     # generations ≈ n_generations * mortality_rate
...
CSV.write(joinpath(output_dir, "Richness_M_Z_No_Disp_Lim_Low_Autocorr.csv"), df_richness)
...
#include("run/Appendix_SST_Low_AutoCor_No_Disp_Lim.jl")
