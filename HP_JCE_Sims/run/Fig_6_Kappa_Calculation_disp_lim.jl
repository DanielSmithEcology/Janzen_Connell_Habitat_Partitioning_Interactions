...
# ========= I/O =========
base_dir = joinpath(@__DIR__, "..", "Outputs", "Fig_6", "simulation_outputs_Fig_6", "Fig_6_JCE_Only_Disp_Lim")
isdir(base_dir) || error("Directory not found: ", base_dir)

out_path = joinpath(base_dir, "Summary_JCE_Only_Disp_Lim_Kappa_Values.csv")
