...
# === Output directory ===
output_dir = joinpath(@__DIR__, "..", "Outputs", "Fig_3", "simulation_outputs_Fig_3B")
...
CSV.write(joinpath(output_dir, "Richness_M_sigmah_No_Disp_Lim_High_Autocorr.csv"), df_richness)
...
#include("run/Fig_3B_Moore_Sigma_High_AutoCor_No_Disp_Lim.jl")
